...
public class Tab4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      final  View v= inflater.inflate(R.layout.fragment_tab4, container, false);
        Button b1=(Button)v.findViewById(R.id.bbbbb);
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText e1=(EditText)v.findViewById(R.id.c1);
                EditText e2=(EditText)v.findViewById(R.id.c2);
               // EditText e3=(EditText)v.findViewById(R.id.c3);
                final FirebaseUser user= FirebaseAuth.getInstance().getCurrentUser();

                Toast.makeText(v.getContext(),""+ e1.getText().toString().equals(e2.getText().toString()),Toast.LENGTH_LONG).show();
                if(e1.getText().toString().equals(e2.getText().toString()) && e1.getText().toString().length()>=6)
                {
                ...
                {
                    Toast.makeText(v.getContext(),"Password Does not match or too short",Toast.LENGTH_LONG).show();
                }
            }
        });
